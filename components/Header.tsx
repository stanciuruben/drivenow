...
const Header: FC = () => {
    ...
    return (
        <header className='relative top-[4.5rem]'>
            ...
            <MainForm />
            <ul className='mb-20 mx-5 flex flex-col md:flex-row justify-center items-center gap-20 text-black font-medium dark:text-white'>
                ...
                <li className='flex items-center gap-5'>
                    <Image src='/icons/steps.svg' alt='Price tag icon' width={70} height={40} />
                    <p>
